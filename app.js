...
const EVIDENCES = [
  {
    id: 1, phase: 1, num: '01',
    title: 'A Assinatura do Criador',
    ref: 'Gênesis 1:1 · Apocalipse 1:8',
    category: 'Filológico · Engenharia Gramatical',
    excerpt: 'A primeira frase da Bíblia contém uma partícula hebraica intraduzível — composta pela primeira e última letra do alfabeto — que aparece antes dos objetos da criação. Milênios depois, em outra língua e outro continente, Jesus a traduz literalmente: "Eu sou o Alfa e o Ômega."',
    fact: 'No texto hebraico de Gênesis 1:1 — "Bereshit bara Elohim et ha-shamayim ve-et ha-aretz" — a partícula <strong>את (Alef-Tav)</strong> aparece duas vezes: antes de "os céus" e antes de "a terra". Ela é intraduzível. Nenhuma versão em português, inglês ou espanhol a renderiza porque não tem equivalente em nenhum idioma moderno.',
    context: 'O hebraico clássico usa את como marcador de objeto direto definido — função puramente gramatical. Mas ela é composta pela <strong>primeira letra</strong> (Alef א) e pela <strong>última letra</strong> (Tav ת) do alfabeto hebraico completo. Isso não é coincidência ortográfica: o hebraico ordena seu alfabeto com a mesma lógica com que o grego ordena o seu — Alef equivale ao Alpha, Tav equivale ao Omega. A partícula que "engloba" os objetos da criação é composta pelas letras que "englobam" o alfabeto inteiro.',
    logic: 'O argumento se move em dois tempos. Primeiro, estrutural: a partícula invisível que aparece entre o sujeito Elohim e os objetos "os céus e a terra" é composta pelas letras que representam o começo e o fim de toda comunicação possível em hebraico — como se houvesse uma assinatura invisível no ato da criação. Segundo, e mais preciso: João registra Jesus dizendo em grego <em>"Ego eimi to Alpha kai to Omega"</em> — "Eu sou o Alfa e o Ômega" (Apocalipse 1:8). Alpha é a primeira letra grega; Omega é a última. Jesus, falando aramaico e citando textos hebraicos, traduz para o grego o conceito exato da partícula Alef-Tav e se identifica com ela. Essa conexão atravessa dois alfabetos, dois idiomas e mais de mil anos. Nenhum dos 40 autores da Bíblia poderia ter coordenado isso — ou um coordenou todos.',
    related: [25, 26],
  },
  {
    id: 2, phase: 1, num: '02',
...
const TERMS = [
  {
    ...
    term: 'A Partícula do Criador',
    meaning: 'Marcador do objeto direto hebraico — composto pela primeira (Alef) e última (Tav) letras do alfabeto. Intraduzível em qualquer língua moderna. Aparece em Gênesis 1:1 como a "assinatura invisível" da criação.',
