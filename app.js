...
const CURIOSITIES = [
  {
    id: 1,
    title: 'A circuncisão no 8º dia — pico de coagulação',
    tag: 'Medicina',
    body: 'Gênesis 17:12 ordena circuncisão no <strong>8º dia de vida</strong>. A medicina moderna descobriu que a vitamina K (essencial para coagulação) e os níveis de protrombina atingem o pico máximo exatamente no 8º dia — o único momento em que o recém-nascido coagula melhor do que um adulto. Qualquer outro dia aumentaria o risco de hemorragia.',
  },
  {
    id: 2,
    title: '"Ele suspende a terra sobre o nada" — Jó 26:7',
    tag: 'Física',
    body: 'Escrito ~2.000 a.C., Jó 26:7 afirma que Deus <strong>"suspende a terra sobre o nada"</strong>. É a única afirmação do mundo antigo de que a terra flutua no vácuo sem suporte. Todas as outras cosmologias colocavam a terra sobre pilares, tartarugas, elefantes ou oceanos. Jó descreve gravidade orbital 3.500 anos antes de Newton.',
  },
  {
    id: 3,
  ...
  {
    id: 9,
    title: 'Hissopo: antissepsia bíblica 3.000 anos antes de Pasteur',
    tag: 'Farmacologia',
    body: 'Deus ordenou o uso de <strong>hissopo</strong> como agente purificador (Êxodo 12:22; Levítico 14; Salmo 51:7). Análises farmacológicas modernas confirmam que o hissopo contém ácido ursólico e diosmetina — compostos com forte atividade antifúngica e antibacteriana comprovada. Era antissepsia prática ~3.000 anos antes de Pasteur.',
  },
  {
    id: 10,
    title: 'A profecia de Tiro verificável por satélite',
    tag: 'Profecia',
    body: 'Ezequiel 26 (~590 a.C.) profetizou que Tiro seria destruída e suas pedras jogadas ao mar. Em 332 a.C., Alexandre Magno destruiu a cidade continental e <strong>literalmente jogou as pedras ao mar</strong> para construir uma ponte de 800 metros até a ilha. A "ilha" de Tiro (atual Líbano) ainda existe sobre as ruínas subaquáticas — visíveis por satélite.',
  },
  {
    id: 11,
    title: 'Jó 9:8 — "estende os céus" e a expansão do universo',
    tag: 'Cosmologia',
    body: 'Jó 9:8 descreve Deus "estendendo os céus sozinho." O verbo hebraico נָטָה (natah) está no particípio — <strong>ação contínua e presente</strong>. Ao menos 17 versículos bíblicos usam o mesmo verbo para os céus sendo "esticados." Em 1929, Hubble descobriu que o universo está em expansão contínua. O texto descreve um processo em andamento.',
  },
  {
    id: 12,
    title: 'Levítico 17:11 — "a vida está no sangue" (3.400 anos antes)',
    tag: 'Medicina',
    body: 'Por milênios, médicos sangravam pacientes como tratamento. George Washington provavelmente morreu de exsanguinação terapêutica em 1799. Levítico 17:11, escrito ~1.400 a.C., afirma explicitamente: <strong>"a vida da carne está no sangue."</strong> A medicina ocidental só reconheceu isso plenamente no séc. XIX.',
  },
  {
    id: 13,
    title: 'Salmo 8:8 e as correntes oceânicas (Matthew Maury)',
    tag: 'Oceanografia',
    body: 'O Salmo 8:8 menciona "as correntes dos mares" (אָרְחוֹת יַמִּים — literalmente <em>caminhos das águas</em>). Matthew Fontaine Maury, fundador da oceanografia moderna, contou que ao ouvir seu filho ler esse versículo decidiu mapeá-las. Em 1855 publicou o primeiro atlas das correntes oceânicas — tomando como ponto de partida a afirmação bíblica.',
  },
  {
    id: 14,
    title: 'Gênesis 2:7 — a poeira da terra como composição química',
    tag: 'Química',
    body: 'Deus formou o homem da "poeira da terra" (עֲפַר מִן־הָאֲדָמָה). A análise química do corpo humano: 65% oxigênio, 18% carbono, 10% hidrogênio, 3% nitrogênio — mais cálcio, fósforo, enxofre e outros minerais, todos encontrados literalmente no solo. A metáfora é quimicamente precisa.',
  },
  {
    id: 15,
    title: 'Hebreus 11:3 — "o visível veio do invisível"',
    tag: 'Física Quântica',
    body: '"Pela fé entendemos que o universo foi formado de modo que o que é visto não se originou do que é visível." A física quântica demonstra que toda matéria é >99,9999% espaço vazio. Partículas subatômicas emergem de flutuações no vácuo quântico. O princípio de que o visível origina-se do invisível é literalmente correto na física de partículas.',
  },
  {
    id: 16,
    title: 'Jó 38:35 — "os relâmpagos carregam mensagens"',
    tag: 'Eletromagnetismo',
    body: 'Deus pergunta a Jó: <em>&ldquo;Podes enviar relâmpagos para que vão e te digam \'Aqui estamos\'?&rdquo;</em> Relâmpagos são descargas de energia eletromagnética. A telegrafia (comunicação por energia elétrica) foi inventada em 1837; o rádio, em 1895. O texto de ~2.000 a.C. descreve exatamente o que hoje chamamos de comunicação eletromagnética.',
  },
  {
    id: 17,
    title: 'Eclesiastes 1:6 — os circuitos dos ventos',
    tag: 'Meteorologia',
    body: '"O vento sopra para o sul, vira para o norte, gira <strong>continuamente em seus circuitos</strong>." Os ventos seguem padrões circulares precisos: células de Hadley nos trópicos, correntes de jato na troposfera, circulação polar. A meteorologia moderna mapeou esses circuitos em detalhes. Salomão os descreveu ~950 a.C.',
  },
  {
    id: 18,
    title: 'Jeremias 33:22 — "incontáveis como as estrelas"',
    tag: 'Astronomia',
